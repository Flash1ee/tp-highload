...
На одного пользователя требуется 1 поток на отправку, 1 на прием, 1 на декодирование видео и аудио и 1 на кодирование.
Итого на 1 пользователя: `4 потока` 
В пике 600 000 пользователей => `4 * 600 000` = `2 400 000 потоков`
На сервер с 64 ядрами(х2), уйдет `2 400 000 / (64 * 2)` = `18 750 серверов`
